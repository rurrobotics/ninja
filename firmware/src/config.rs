...
pub const DRIVETRAIN_DEFAULT_COLOR: Color = Color::Blue;
...
pub const POWER_DEFAULT_MAX_SPEED: f64 = TRAPEZOID_DEFAULT_MAX_SPEED * 0.8;
pub const POWER_DEFAULT_ACCELERATION: f64 = TRAPEZOID_DEFAULT_ACCELERATION * 0.8;
